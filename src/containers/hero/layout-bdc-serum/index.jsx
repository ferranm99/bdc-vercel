...
const HeroAreaBdcSerum = ({ data }) => (
    <div className="banner-style-4 rn-section-gapTop rn-section-gapBottom">
        <div className="container element" id="bdc-serum">
            <div className="row align-items-center">
                <div className="col-xl-6 col-lg-6 col-md-12 order-2 order-lg-1 mt_md--40 mt_sm--40 pl_md--25 pl_sm--25">
                    <div className="sldier-content">
                        ...
                        >
                            <span className="customTitleFont">Bad Dogs</span> Energy Pack
                        </h1>
                        <p>
                            100% pure rocket fuel for Bad Dogs. It's
                            better than serum!
                        </p>
                        <h3>INFO</h3>
...
export default HeroAreaBdcSerum;
