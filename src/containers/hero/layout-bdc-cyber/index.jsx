...
const HeroAreaBdcCyber = ({ data }) => (
    <div className="banner-style-4 rn-section-gapTop rn-section-gapBottom">
        <div className="container element" id="bdc-cyberdog">
            <div className="row align-items-center">
                ...
                <div className="col-xl-6 col-lg-6 col-md-12 order-1 order-lg-2">
                    <Image
                        src="/images/bdc/nft/cyborg-667px.png"
...
export default HeroAreaBdcCyber;
